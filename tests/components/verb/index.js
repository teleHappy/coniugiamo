...
describe('Testing Verb component', function(){
    ...
    describe('Testing verb stems for regular "are" conjugation', function(){
        ...
        it('present tense:returns properly formatted regular verb stem for "-ciare", "-giare" verbs', function(){
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'io'), 'cominc')
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'tu'), 'cominc')
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'lui/lei/Lei'), 'cominc')
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'noi'), 'cominc')
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'voi'), 'cominc')
            assert.equal(verb.areTableGenerator.getVerbStem('cominciare', 'subjunctive', 'loro/Loro'), 'cominc')
            
            assert.equal(verb.areTableGenerator.getVerbStem('mangiare', 'present', 'io'), 'mangi')
            assert.equal(verb.areTableGenerator.getVerbStem('mangiare', 'present', 'tu'), 'mang')
            assert.equal(verb.areTableGenerator.getVerbStem('mangiare', 'present', 'lui/lei/Lei'), 'mangi')
